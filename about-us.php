                ...
                <div class="overlay-bg t50">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <h1>About Us</h1>
								<p>We bring creating solution for your brand</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="inner-padding">
                            <div class="col-md-4 offset-md-8 wow fadeIn">
                                <h2 class="mb20">Who is PrismaGrowth.</h2>
                                <p>PrismaGrowth is a growing and emerging website design company.
                                ...
                                Our mission is what drives us to everything possible to expand human potential.
                                As a website design company, we stress more on the latest design and cover all 
                                the aspects of the UI/UX approach. We use an innovative customer-centric 
                                approach and focus on user-friendly website design which are compatible 
                                with all devices.
                                </p>
                            </div>
                        </div>
							...
							<div class="row sequence">
								...
								<div class="col-md-6 mb40 sq-item wow sq-item wow">
									<div class="feature-box style-2">
										...
										<div class="text">
											<h3>Our Vision</h3>
											To become world's most reliable & easy to work with website company.</div>
									</div>
								</div>
								<!-- feature box close -->
								...
								<div class="col-md-6 feature-box mb40 sq-item wow">
									<div class="feature-box style-2">
										...
										<div class="text">
											<h3>Our Mission</h3>
											Help businesses around the world to excel on internet</div>
									</div>
								</div>
								<!-- feature box close -->
