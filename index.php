...
<?php include('includes/nav.php'); ?>
        ...
        <div id="content" class="no-bottom no-top">
            ...
            <!-- section begin -->
            <section id="section-intro" class="full-height relative owl-slide-wrapper text-light no-top no-bottom" data-bgimage="url(images/background/9.jpg)" data-stellar-background-ratio=".2">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <h1 class="big b">PrismaGrowth  <!-- <span class="id-color">&amp;</span>  --></h1>
                                    <h3>Grow More With Us</h3>
							...
							<div class="row sequence">
								...
								<div class="col-md-6 mb40 sq-item wow sq-item wow">
									<div class="feature-box style-2 left">
										...
										<div class="text">
                                            ...
                                            Create better websites with PrismaGrowth. 
                                         </div>
									</div>
								</div>
								<!-- feature box close -->
								...
								<div class="col-md-6 feature-box mb40 sq-item wow">
									<div class="feature-box style-2 left">
										...
										<div class="text">
                                            ...
                                            Start a blog, sell your products or services and make smart decisions with clear analytics. 
                                        </div>
									</div>
								</div>
								<!-- feature box close -->
								...
								<div class="col-md-6 feature-box sm-mb40 sq-item wow">
									<div class="feature-box style-2 left">
										...
										<div class="text">
											<h3>Development</h3>
                                            Our designers will bring your vision to life.
                                            Mobile resposive and with unlimited customization.
            ...
            <section data-bgcolor="#f9f9f9">
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6">
                            <img src="images/misc/laptop.png" class="mb-sm-30 img-fluid" alt="">
                        </div>

                        <div class="col-md-5 offset-md-1">
                            <h2 class="mb20">We bring creative solution for your brand</h2>
                            <p>A more valuable way where customers are earned rather than bought.
                                We are obsessively passionate ablout it & our mission is 
                                to help people achieve it.
                            </p>
                            <div class="spacer-half"></div>
                            <a href="#section-portfolio" class="btn-custom scroll-to">More About Us</a>
                        </div>
                            ...
                            <div id="blog-carousel" class="owl-carousel owl-theme">
                                ...
                                <div class="post-item s1 item">
                                    <div class="post-content">
                                        ...
                                        <div class="post-text">
                                            <h3><a href="#">Avoid Errors In UI Design</a></h3>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                                        </div>
                                    </div>
                                </div>
